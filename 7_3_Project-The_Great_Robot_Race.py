...
while not rr.is_race_over(bots) and num_of_turns < max_turns:
  # For every bot in the list of bots, if the bot has not reached the end,
  # add a new move to the robot_moves deque
...
# Calculate the scores (moves + collisions) for each robot and append it
# to bot_scores
bot_scores = []
...
while len(robots_moves) > 0:
  # Make sure to pop moves from the front of the deque




  # Update the maze characters based on the robot positions and print it to the
  # console
